...
def write_user_controlled_episode_to_tf_record(episode_index, write_dir, max_episode_length):
...
def generate_user_controlled_vae_data(args):
    ...
    for episode_index in range(starting_episode_index, ending_episode_index):
        frames_written_in_each_episode.append(write_user_controlled_episode_to_tf_record(
...
def generate_random_vae_data(args):
    ...
    with multiprocessing.Pool(processes=args.num_processes) as pool:
        frames_written_in_each_episode = pool.starmap(write_user_controlled_episode_to_tf_record,
...
if __name__ == '__main__':
    ...
    if not args.user_controlled:
        ...
        generate_user_controlled_vae_data(args)
